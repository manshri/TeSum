...
LANGUAGES.update({'massivesumm': {'hi': 'hin', 'te': 'tel', 'mr': 'mar', 'gu': 'guj'}})
...
class Config:
    ...
    file_exts = {'xlsum': "_total.jsonl", 'massivesumm': ".all.jsonl", 'tesum': "_tesum_all.jsonl"}
    ...
    def __init__(self, source='./', dataset='xlsum', lang='te', filetype='.jsonl'):
        ...
        self.dataset_dir = {'massivesumm': self.source + 'massivesumm/', 'xlsum': self.source + 'xlsum/%s_XLSum_v2.0/'%LANGUAGES[self.dataset][self.lang]}
        ...
        self.save_dir = {'xlsum': './excluded_IDs/xlsum/%s_XLSum_v2.0/'%LANGUAGES[self.dataset][self.lang] + self.lang + "_", 'massivesumm': './excluded_IDs/massivesumm/' + self.lang + "_"}
